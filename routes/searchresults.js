...
router.get('/', apiSearch, (req, res) =>  {
    ...
    res.render('searchresults/index', { departurecode: res.departurecode, arrivalcode: res.arrivalcode, departdate: res.departdate, departtime: res.departtime, arrivetime: res.arrivetime, flightnumber: res.flightnumber, departurecity: res.departurecity, arrivalcity: res.arrivalcity, resultsLength: res.resultsLength, price: res.price})
})
